...
import com.consultantvendor.ui.loginSignUp.references.ReferenceFragment
                ...
                Status.SUCCESS -> {
                    ...
                    if (arguments?.getBoolean(UPDATE_PROFILE, false) == true) {
                        ...
                        when (prefrenceType) {
                            ...
                            PreferencesType.COVID -> {
                                //bundle.putString(MASTER_PREFRENCE_TYPE, PreferencesType.REFERENCES)
                                fragment = DocumentsFragment()
                            }
                            /*PreferencesType.REFERENCES -> {
                                //bundle.putString(MASTER_PREFRENCE_TYPE, PreferencesType.REFERENCES)
                                fragment = DocumentsFragment()
                            }*/
                            else -> {
